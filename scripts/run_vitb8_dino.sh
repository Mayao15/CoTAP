...
loss_fn=full_loss training.num_gpus=8 dataset_train=coco+in1k training.batch_size=8 training.use_mask=False training.max_steps=210000 training.lr=3e-5 model=vit_base_8 model.n_projection_head=2 model.nmb_prototypes=[512,4096] \
basic.experiment_name="vitb8/dino" \
